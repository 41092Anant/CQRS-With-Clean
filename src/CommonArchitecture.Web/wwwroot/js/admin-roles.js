// Admin Roles Index Page - JavaScript Module
...
$(document).ready(function () {
    ...
    function loadRoleForEdit(roleId) {
        ...
        $.ajax({
            url: `${areaPrefix}/Roles/GetById/${roleId}`,
            type: 'GET',
            success: function (response) {
                if (response.success) {
    ...
    function saveRole() {
        ...
        const url = isEditMode
            ? `${areaPrefix}/Roles/Edit/${currentRoleId}`
            : `${areaPrefix}/Roles/Create`;
