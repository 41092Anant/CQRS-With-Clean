using CommonArchitecture.Application.Commands.Users.CreateUser;
using CommonArchitecture.Application.Commands.Users.DeleteUser;
using CommonArchitecture.Application.Commands.Users.UpdateUser;
...
public class UsersController : ControllerBase
{
    ...
    public UsersController(IMediator mediator, IWebHostEnvironment environment, ILogger<UsersController> logger)
    {
        _mediator = mediator;
    ...
    [HttpPost]
    public async Task<ActionResult<UserDto>> Create([FromForm] CreateUserFormDto formDto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromForm] UpdateUserFormDto formDto)
    {
